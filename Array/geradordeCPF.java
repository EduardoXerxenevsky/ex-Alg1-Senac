...
public class geradordeCPF {
    public static void main(String[] args) {
        ...
        int cpfrand;
        cpfrand = rand.nextInt(999999999);
String newCPF="";
newCPF= newCPF.valueOf(cpfrand);
        newCPF= newCPF+calcDv1(newCPF);
        newCPF= newCPF+calcDv2(newCPF);
        System.out.println("SEU CPF GERADO É: "+newCPF);
